 ...
 */
@Autonomous(name = "AutoLine", group = "Decode")
public class AutoLine extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        bumble.setCollisionSafety(
                10.0,   // stopDistance inches
                1500,   // max wait before abort
                40,     // check interval
                2       // confirm reads
        );
        ...
        //drive forward safe
        boolean ok = bumble.driveForwardAutoSafe(this, distanceReader, 24, 0.2);
